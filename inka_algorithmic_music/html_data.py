...
def get_html_source(html_id):
    ...
    if html_id == 0:
        txt = """
            ...
            <title>Inka Algorithmic Music</title>
            <meta charset="utf-8">
            <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
            <meta name="description" content="Creates algorithmic music based on artificial composition rules">
            <meta name="keywords" content="algorithmic music,artificial music,algorithmic composition,artificial composition,artificial composer,software generated music,computer generated music,algorithmische Musik">
